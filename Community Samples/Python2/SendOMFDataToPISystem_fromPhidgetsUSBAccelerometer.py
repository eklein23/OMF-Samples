...
# NOTE: this example was designed to use the following USB accelerometer module:
# https://www.phidgets.com/?tier=3&catid=10&pcid=8&prodid=1037
...
# To specifically enable Python support for the Phidget accelerometer, see
...
DEVICE_NAME = "Phidgets 3-Axis Accelerometer"
...
# Define a variable for the accelerometer
ch = 0

# Define helper functions to handle when the accelerometer is connected or disconnected
def AccelerometerAttached(self):
    try:
        attached = self
...
def AccelerometerDetached(self):
    detached = self
    try:
            ...
            "values": [
                {
                    ...
                    "X Acceleration": acceleration[0],
                    "Y Acceleration": acceleration[1],
                    "Z Acceleration": acceleration[2]
